...
export class InitTable1634132527068 implements MigrationInterface {
    name = 'InitTable1634132527068'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`tag\` (\`id\` int NOT NULL AUTO_INCREMENT, \`title\` varchar(20) NOT NULL COMMENT '标签名', \`articleId\` int NOT NULL COMMENT '文章ID', \`createTime\` varchar(20) NOT NULL COMMENT '创建时间', PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
